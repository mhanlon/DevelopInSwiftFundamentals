 ...
 */
var destropyer = Fighter()
destropyer.weapon = "Laser"
destropyer.remainingFirePower = 10
destropyer.name = "Destroyer"
print(destropyer.position)
destropyer.moveRight()
print(destropyer.position)
/*:
...
// falcon.weapon = "AA"
// falcon is an instance of Spaceship, not a instance of Fighter, so it does not have the weapon property.
