...
print("Position before: \(destroyer.position)")
destroyer.moveRight()
print("Position after: \(destroyer.position)")
 ...
 */
// falcon is an instance of Spaceship, which does not have weapon property. Only Fighter instances has this property defined.
