 ...
 */
// print(falcon.weapon)  It doesn't work because falcon hasn't a property named "weapon". This property is in a subclass only
 ...
 */
destroyer.fire()
print("You have more \(destroyer.remainingFirePower) power")
destroyer.fire()
print("You have more \(destroyer.remainingFirePower) power")
destroyer.fire()
print("You have more \(destroyer.remainingFirePower) power")
