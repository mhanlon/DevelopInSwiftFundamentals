...
// The scope of variable foo is limited to the body of the loop (local scope), therefore it cannot be accessed from a global scope.
/*:
...
// x is defined in global scope and can be accessed both from inside of the body of the loop and by the last print statement (from a global scope).
/*:
