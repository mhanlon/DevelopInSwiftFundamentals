...
print("the value of foo is not accessible for the second print because foo is declared inside the for loop")
/*:
...
print("x is delcared outside the for loop")
...
greeting(greeting: "Hi there", name: "Robert")
greeting(greeting: nil, name: "Micheal")
/*:
