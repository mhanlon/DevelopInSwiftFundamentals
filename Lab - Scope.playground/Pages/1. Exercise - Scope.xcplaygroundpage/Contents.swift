...
// foo is only available within the for-loop.
/*:
...
// the first x is defined as a global variable, which can be accessed after the for-loop. The scope of the first x has the global scope, while the scope of x in for-loop is limited to the inside of the curly brackets of the for-loop. The scope of foo is the inside of the curly brackets of the for-loop.
/*:
...
var car = Car(make: "Honda", model: "Civic", year: 2007)
print(car.make)
