...
let restrauntHasFish = true
let restrauntHasPizza = false
let restrauntHasVegan = true

if hasFish == restrauntHasFish && hasPizza == restrauntHasPizza && hasVegan == restrauntHasVegan {
    print("Let's go!")
} else {
