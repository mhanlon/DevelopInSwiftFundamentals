 ...
 */
let friends = 55 //number of facebook friends
print("friends") // output to the terminal
 ...
 */
// friends = friends -1
// cant do the above its a constant
 ...
 */
print("you cannot change the value of a constant\nInstead use var to declare it if you want it to be variable")
//note the use of the escape \n to add a new line within the string
