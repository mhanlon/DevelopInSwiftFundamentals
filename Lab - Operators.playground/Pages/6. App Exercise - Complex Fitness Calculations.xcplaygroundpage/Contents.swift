 ...
 */
let anotherHeartRate1: Double = 87
let anotherHeartRate2: Double = 72
let anotherHeartRate3: Double = 87
let anotherAverageHR = (anotherHeartRate1 + anotherHeartRate2 + anotherHeartRate3) / 3
print(anotherAverageHR)
/*:
