...
print("In this case heartRates are defined as Double, so the resulting addedHRD and averageHRD are Double having decimal points, while in the prevous case the corresponding constants are Int.")
/*:
