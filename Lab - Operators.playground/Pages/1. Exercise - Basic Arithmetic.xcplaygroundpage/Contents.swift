...
print("In human-math terms I would naturally expect to get 10.333(3) as the result of the aforementioned operation.")
...
print("Now we operate on Doubles so the required precision is there.")
/*:
...
print("The diameter equals \(diameter) and the circumfenerce \(circumference)./")
...
let even: Int = 8
let odd: Int = 7
print("Remainder of dividing the even value by 2: \(even % 2).")
print("Remainder of dividing the odd value by 2: \(odd % 2).")
print("Well... As one can see, whenever we examine an odd number the modulo operator returns 1.")
/*:
