...
//We use double so result is double, that's why result got decimal
/*:
...
print(even % 2)
print(odd % 2)
//if number remainder of dividing value of 2 is 0, we can say that the number is even (because this number is multiple of 2 : It's mathematic 🙂)
