...
func checkAge(givenAge: String) -> Int? {
    if let unwrappedAge = Int(givenAge) {
        if unwrappedAge >= 18 {
            print("Welcome!")
        } else {
...
checkAge(givenAge: userInputAge)
checkAge(givenAge: "34")
checkAge(givenAge: "17")
//:  Go back and update your function to return the age as an integer. Will your function always return a value? Make sure your return type accurately reflects this. Call the function and print the return value.
print(checkAge(givenAge: userInputAge))
print(checkAge(givenAge: "7"))
print(checkAge(givenAge: "77"))
...
func price(of item: String) -> Double? {
