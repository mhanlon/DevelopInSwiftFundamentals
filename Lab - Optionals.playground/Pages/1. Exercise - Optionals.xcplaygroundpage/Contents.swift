 ...
 */
// userAge's value is nil because "34e" does not represent an integer value, thus Int initialization fails.
 ...
 */
// The integer value has been printed as "Optional(34)". Let's unwrap it to get just the integer value.
print(userAge!)
