...
var hrAverage = Double(oldHR1 + oldHR2 + oldHR3 + oldHR4) / 4.0
print(hrAverage)
/*:
 ...
 */
hrAverage = 0
if let heartRateUnwrapped = heartRate {
    hrAverage = Double(oldHR1 + oldHR2 + oldHR3 + oldHR4 + heartRateUnwrapped) / 5.0
} else {
    hrAverage = Double(oldHR1 + oldHR2 + oldHR3 + oldHR4) / 4.0
}
print(hrAverage)
