...
struct RunningWorkout {
    ...
    var averageMileTime: Double {
        let miles = self.distance / 1600.0
        return self.time / miles
    }
}

let workout = RunningWorkout(distance: 10, time: 60, elevation: 45)
    ...
    var steps: Int {
        willSet {
            if newValue == self.goal {
                print("Congratulations, you've met your goal !")
            }
        }
    }
    var goal: Int
...
var walk = Steps(steps: 9999, goal: 10_000)
walk.takeStep()
