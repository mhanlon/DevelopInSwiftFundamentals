 ...
 */
let somePlace = GPS(latitude: 51.5140004, longitude: 0.125226)
...
let book = Book(title: "Winnie-The-Pooh", author: "A. A. Milne", pages: 176, price: 46.49)
print("My favorite book is \(book.title) by \(book.author)")
/*:
 ...
 */
var myHeight = Height(heightInCentimeters: 168)
