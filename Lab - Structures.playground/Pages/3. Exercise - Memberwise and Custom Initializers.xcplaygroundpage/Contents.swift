...
var favoriteBook = Book(title: "Develop in Swift Fundamentals", author: "Apple", pages: 603, price: 0.0)
print("\(favoriteBook.title) wrotten by \(favoriteBook.author) is \(favoriteBook.pages) pages long and is free (\(favoriteBook.price)€)")
/*:
