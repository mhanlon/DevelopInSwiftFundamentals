...
var favoriteBook = Book(title: "Harry Potter", author: "J.K.Rowling", pages: 500, price: 19.56)

print("My favorite book is \(favoriteBook.title) by \(favoriteBook.author). It has \(favoriteBook.pages) pages and it costs \(favoriteBook.price) euros.")
 ...
 */
var myHeight = Height(heightInCentimeters: 170.0)
