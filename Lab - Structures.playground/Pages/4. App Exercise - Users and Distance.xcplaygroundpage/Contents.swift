 ...
 */
var Roberta = User(name: "Roberta", age: 28, height: 60, weight: 140, activityLevel: 3)
print("My name is \(Roberta.name). I am \(Roberta.age), weight \(Roberta.weight) lbs and am \(Roberta.height) inches tall. On an activity scale from 1-10 I am probably a \(Roberta.activityLevel).")
