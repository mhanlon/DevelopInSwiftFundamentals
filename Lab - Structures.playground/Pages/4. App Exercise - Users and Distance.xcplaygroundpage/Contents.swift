 ...
 */
var mySelf = User(name: "Nipun", age: 29, height: 170.0, weight: 70.0, activityLevel: 4)
print("Myb name is \(mySelf.name), I'm \(mySelf.age) years old. I'm \(mySelf.height)cm taller and \(mySelf.weight)kgs. My activity level is \(mySelf.activityLevel) on a scale from 0 to 10")
 ...
 */
let distance2 = Distance(meters: 5000)
