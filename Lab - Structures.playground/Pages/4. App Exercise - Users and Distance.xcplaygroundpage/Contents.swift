...
var milosz = User(name: "Miłosz", age: 36, height: 186, weight: 79, activityLevel: 7)
print("\(milosz.name) is \(milosz.age), having height of \(milosz.height) centimeters, weight of \(milosz.weight) kilos and activity level of \(milosz.activityLevel).")
