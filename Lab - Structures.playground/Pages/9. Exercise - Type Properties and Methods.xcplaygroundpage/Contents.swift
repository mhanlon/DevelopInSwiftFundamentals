...
struct User {
    ...
    static var currentUser: User = User(userName: "Andoria92", email: "liferoan@hotmail.it", age: 28)
 ...
 */
let newUser = User(userName: "Andoria Andorra", email: "andorra@gmail.com", age: 20)
