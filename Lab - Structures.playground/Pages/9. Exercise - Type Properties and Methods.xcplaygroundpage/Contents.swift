...
struct User {
    ...
    static var currentUser: User = User(userName: "Kimiaki Shiarahama", email: "shirahama@info.kindai.ac.jp", age: 40)
 ...
 */
User.logIn(user: User(userName: "John Smith", email: "john@aaa.com", age: 50))
