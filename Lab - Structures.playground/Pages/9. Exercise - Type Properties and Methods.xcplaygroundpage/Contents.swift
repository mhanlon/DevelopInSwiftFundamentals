...
struct User {
    ...
    static var currentUser: User = User(userName: "Jolanta", email: "soja@k7.eu", age: 34)
...
print("The current user is \(User.currentUser.userName) <\(User.currentUser.email)>, \(User.currentUser.age).")
/*:
 ...
 */
let anotherUser = User(userName: "John", email: "john@example.com", age: 20)
