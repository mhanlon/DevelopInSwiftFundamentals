 ...
 */
var walkingChallenges: [String] = ["Walk 3 miles a day","Walk 5 miles a day","Walk 10 miles a day"]
var runningChallenges: [String] = ["Run 1 times a week", "Run 3 times a week","Run 5 times a week"]
...
if userChallenges.isEmpty{
    ...
    print("The challenge you have choosen is \(userChallenges[0])")
} else {
