...
let colorsAndShapes = Dictionary(uniqueKeysWithValues: zip(colorsArray, shapesArray))
 ...
 */
if let colorAndShape = colorsAndShapes[colorsArray[colorsArray.count-1]] {
    print(colorsArray[colorsArray.count-1])
}
